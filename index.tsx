        ...
        >
          <div className="aspect-video overflow-hidden rounded-[1.8rem] relative">
            ...
            <div className="absolute bottom-8 left-10 text-left">
              <p className="text-white font-black text-[10px] md:text-sm uppercase tracking-[0.3em]">Astana • 2024</p>
              <p className="text-white/60 text-[8px] md:text-xs uppercase font-bold tracking-widest mt-1">Délégation France</p>
            </div>
          </div>
        </a>
    ...
    switch(index) {
      case 0: return (
        <section className="slide-enter flex flex-col items-center text-center max-w-5xl py-8">
          ...
          <p className="text-base md:text-2xl text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed font-light">
        ...
        <section className="slide-enter flex flex-col md:flex-row items-center gap-10 max-w-6xl w-full text-left py-8">
          <div className="flex-1 space-y-6">
            ...
            <div className="flex items-center gap-4">
               ...
               <p className="text-xs md:text-sm text-slate-400">Patrimoine Mondial de l'UNESCO</p>
            </div>
          </div>
        ...
        <section className="slide-enter flex flex-col items-center max-w-6xl w-full py-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full items-stretch">
            <div className="lg:col-span-8 flex flex-col justify-center text-left space-y-10">
              <div>
                <div className="flex items-center gap-3 mb-4 text-[#D4AF37] font-black tracking-[0.3em] uppercase text-[10px]">
              ...
              <div className="flex flex-wrap gap-3">
                 <div className="px-4 py-2 md:px-5 md:py-3 glass rounded-full flex items-center gap-3 border-[#0055A4]/30">
                    ...
                    <span className="text-[9px] md:text-[10px] uppercase font-black text-slate-400 tracking-wider">Patrimoine UNESCO</span>
                 </div>
                 <div className="px-4 py-2 md:px-5 md:py-3 glass rounded-full flex items-center gap-3 border-[#EF4135]/30">
                    ...
                    <span className="text-[9px] md:text-[10px] uppercase font-black text-slate-400 tracking-wider">Ambition Mondiale</span>
                 </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-4 flex flex-col gap-4 text-left">
              <div className="glass p-5 md:p-6 rounded-[2rem] border-t-4 border-[#D4AF37] flex-grow">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#D4AF37] text-[9px] md:text-[10px] font-black uppercase tracking-wider">5<sup>ème</sup> Place Mondiale</p>
                  </div>
                </div>
                <p className="text-slate-400 text-[11px] md:text-xs font-light leading-relaxed">
              ...
              <div className="glass p-5 md:p-6 rounded-[2rem] border-t-4 border-[#0055A4] flex-grow">
                ...
                <div className="flex justify-between items-baseline mb-2">
                  <p className="text-[#0055A4] text-[10px] font-black uppercase tracking-wider">22<sup>ème</sup> Mondial</p>
                  <p className="text-slate-500 text-[9px] font-bold">Top Européen</p>
                </div>
                <p className="text-slate-400 text-[11px] md:text-xs font-light leading-relaxed">
        ...
        <section className="slide-enter flex flex-col items-center max-w-6xl w-full text-center py-8">
          ...
          <div className="mt-12 flex justify-center">
            ...
            >
              ...
              <span className="text-[9px] md:text-[10px] uppercase font-black tracking-[0.3em] text-white/50 group-hover:text-white">Devenir Partenaire</span>
            </button>
          </div>
        </section>
      );
      case 6: return (
        <section className="slide-enter flex flex-col items-center max-w-6xl w-full py-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-10 text-white uppercase tracking-tighter">La Délégation 2026</h2>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 md:gap-8 w-full">
            {[
              ...
              <div key={i} className="flex flex-col items-center group">
                ...
                <p className="font-bold text-[10px] md:text-sm text-white text-center leading-tight">{m.name}</p>
              ...
              <div key={i} className="flip-card h-[280px] md:h-[300px]">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back p-6 md:p-8 flex flex-col items-center justify-center text-center rounded-[1.5rem]" style={{backgroundColor: d.c, color: d.c === "#D4AF37" ? "#000" : "#fff"}}>
                    <h4 className="font-bold mb-3 uppercase tracking-widest text-[10px] md:text-xs">Aperçu</h4>
                    <p className="text-[11px] md:text-sm leading-relaxed font-medium">{d.desc}</p>
                  </div>
                </div>
              </div>
            ))}
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full">
              {[
                ...
                <div key={i} className="flex gap-4 p-5 md:p-6 glass rounded-2xl border-l-4 transition-colors" style={{borderLeftColor: obj.color}}>
                  ...
                  <div>
                    <h4 className="font-bold text-sm md:text-lg mb-1 text-white">{obj.title}</h4>
                    <p className="text-[10px] md:text-xs text-slate-400 font-light leading-snug">{obj.desc}</p>
                  </div>
                </div>
              ))}
           </div>
      ...
      case 9: return (
        <section className="slide-enter flex flex-col items-center max-w-5xl w-full text-center py-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-10 text-white uppercase italic tracking-tighter">Calendrier Opérationnel</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 w-full">
             {[
               ...
               <div key={i} className="flex flex-col items-center">
                  <div className="w-10 h-10 rounded-full glass border border-white/20 flex items-center justify-center font-black text-[9px] text-[#D4AF37] mb-4">{s.date}</div>
                  <h4 className="font-bold text-white text-[10px] md:text-xs mb-1 uppercase tracking-widest">{s.label}</h4>
                  <p className="text-[9px] md:text-[10px] text-slate-500 font-medium px-4">{s.desc}</p>
               </div>
             ))}
          </div>
        </section>
           ...
           <div className="w-full glass p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 text-left items-center">
              <div>
                 <div className="mb-6 text-center lg:text-left">
                    <p className="text-[9px] md:text-[10px] uppercase text-slate-500 font-black tracking-[0.2em] mb-1">Besoin Global</p>
                    <p className="text-4xl md:text-6xl font-black text-white">5 640 <span className="text-xl md:text-2xl">€</span></p>
                 </div>
                 <div className="space-y-4">
                    <div className="flex justify-between text-[9px] md:text-[10px] font-bold uppercase tracking-widest text-slate-400"><span>Transport Aérien</span><span>2 500 €</span></div>
                    <div className="h-1.5 bg-white/5 rounded-full overflow-hidden"><div className="h-full bg-[#0055A4] rounded-full w-[44%]"></div></div>
                    <div className="flex justify-between text-[9px] md:text-[10px] font-bold uppercase tracking-widest text-slate-400"><span>Logistique & Vie</span><span>1 500 €</span></div>
                    <div className="h-1.5 bg-white/5 rounded-full overflow-hidden"><div className="h-full bg-[#EF4135] rounded-full w-[26%]"></div></div>
                 </div>
              </div>
              <div className="space-y-5">
                 <h4 className="text-base md:text-xl font-bold text-[#D4AF37] italic uppercase">Opportunité RSE</h4>
                 <p className="text-slate-400 text-xs md:text-sm leading-relaxed font-light">Investir dans un projet à haute valeur culturelle, humaine et éducative avec une visibilité mondiale unique.</p>
                 <div className="inline-flex gap-4 items-center px-5 py-3 bg-white/5 rounded-full text-[8px] md:text-[9px] font-black uppercase text-white tracking-[0.2em]">
        ...
        <section className="slide-enter flex flex-col items-center max-w-6xl w-full text-center py-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 w-full">
            {[
              ...
              <div key={i} className="glass p-4 md:p-6 rounded-2xl group hover:bg-white/5 transition-all">
                 <item.icon className="w-7 md:w-10 h-7 md:h-10 text-[#D4AF37] mx-auto mb-4" />
                 <h4 className="text-[11px] md:text-lg font-bold text-white mb-2 uppercase italic">{item.title}</h4>
                 <p className="text-[7px] md:text-[10px] text-slate-500 leading-relaxed font-black uppercase tracking-widest">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="slide-enter flex flex-col items-center max-w-6xl w-full py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 w-full text-left">
            <div className="glass p-6 md:p-8 rounded-3xl flex flex-col h-full border border-white/10">
               <h3 className="text-sm md:text-base font-black text-slate-400 uppercase mb-1 md:mb-2 tracking-widest">Bronze</h3>
               <p className="text-2xl md:text-4xl font-black text-white mb-6 md:mb-8">500 €</p>
               <ul className="text-[10px] space-y-3 text-slate-400 mb-8 flex-grow">
                 <li className="flex gap-2"><Check className="text-[#0055A4] w-3 h-3 mt-0.5" /> Logo sur site web</li>
                 <li className="flex gap-2"><Check className="text-[#0055A4] w-3 h-3 mt-0.5" /> Mentions réseaux</li>
                 <li className="flex gap-2"><Check className="text-[#0055A4] w-3 h-3 mt-0.5" /> Certificat Mécénat</li>
               </ul>
               <button onClick={() => setCurrentSlide(14)} className="w-full py-3 rounded-xl border border-white/10 hover:bg-white/5 uppercase text-[8px] md:text-[9px] font-black tracking-widest">Choisir</button>
            </div>
            <div className="glass p-6 md:p-8 rounded-3xl flex flex-col h-full border-2 border-[#D4AF37] md:scale-105 bg-white/5 shadow-2xl">
               <div className="bg-[#D4AF37] text-black text-[8px] md:text-[9px] font-black px-4 py-1 rounded-full w-fit mb-4 uppercase">Le plus populaire</div>
               <h3 className="text-sm md:text-base font-black text-white uppercase mb-1 md:mb-2 tracking-widest">Argent</h3>
               <p className="text-2xl md:text-4xl font-black text-white mb-6 md:mb-8">1 500 €</p>
               <ul className="text-[10px] space-y-3 text-white/80 mb-8 flex-grow">
                 <li className="flex gap-2"><Check className="text-[#D4AF37] w-3 h-3 mt-0.5" /> Pack Bronze Inclus</li>
                 <li className="flex gap-2"><Check className="text-[#D4AF37] w-3 h-3 mt-0.5" /> Logo Tenue Officielle</li>
                 <li className="flex gap-2"><Check className="text-[#D4AF37] w-3 h-3 mt-0.5" /> Branding tournois</li>
               </ul>
               <button onClick={() => setCurrentSlide(14)} className="w-full py-3 rounded-xl bg-[#D4AF37] text-black uppercase text-[8px] md:text-[9px] font-black tracking-widest hover:scale-105 transition-transform shadow-lg">Participer</button>
            </div>
            <div className="glass p-6 md:p-8 rounded-3xl flex flex-col h-full border border-white/5">
               <h3 className="text-sm md:text-base font-black text-[#EF4135] uppercase mb-1 md:mb-2 tracking-widest">Or / Platine</h3>
               <p className="text-2xl md:text-4xl font-black text-white mb-6 md:mb-8">3 000 € +</p>
               <ul className="text-[10px] space-y-3 text-slate-400 mb-8 flex-grow">
               ...
               <button onClick={() => setCurrentSlide(14)} className="w-full py-3 rounded-xl border border-[#EF4135] text-[#EF4135] uppercase text-[8px] md:text-[9px] font-black tracking-widest hover:bg-[#EF4135]/10">Contact direct</button>
            </div>
          </div>
        </section>
      );
      case 13: return (
        <section className="slide-enter flex flex-col items-center max-w-6xl w-full text-center py-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 w-full">
            <div className="glass p-4 rounded-[1.5rem] md:rounded-[2rem] flex flex-col items-center justify-center border-t-4 border-[#0055A4] h-36 md:h-48 transition-all">
              <div className="text-[7px] md:text-[10px] font-bold text-[#0055A4] uppercase mb-2 md:mb-4 tracking-widest">Soutien Local</div>
              <Landmark className="w-7 md:w-12 h-7 md:h-12 text-white/40 mb-2" />
              <p className="font-bold text-[9px] md:text-sm">Mairie de <br/>La Saulce</p>
            </div>
            <div className="glass p-4 rounded-[1.5rem] md:rounded-[2rem] flex flex-col items-center justify-center border-t-4 border-[#EF4135] h-36 md:h-48 transition-all">
              <div className="text-[7px] md:text-[10px] font-bold text-[#EF4135] uppercase mb-2 md:mb-4 tracking-widest">Organisateur</div>
              <Shield className="w-7 md:w-12 h-7 md:h-12 text-white/40 mb-2" />
              <p className="font-bold text-[9px] md:text-sm">Comité WNG <br/>Officiel</p>
            </div>
            <div className="glass p-4 rounded-[1.5rem] md:rounded-[2rem] flex flex-col items-center justify-center border-dashed border-2 border-white/10 h-36 md:h-48 group cursor-pointer hover:border-[#D4AF37]/30 transition-all" onClick={() => setCurrentSlide(14)}>
              <PlusCircle className="w-7 md:w-10 h-7 md:h-10 text-white/10 group-hover:text-[#D4AF37] transition-colors mb-2" />
              <p className="text-[7px] md:text-[10px] uppercase font-bold text-white/20 group-hover:text-[#D4AF37] text-center">Votre Logo <br/>Ici</p>
            </div>
            <div className="glass p-4 rounded-[1.5rem] md:rounded-[2rem] flex flex-col items-center justify-center border-dashed border-2 border-white/10 h-36 md:h-48 group cursor-pointer hover:border-[#D4AF37]/30 transition-all" onClick={() => setCurrentSlide(14)}>
              <PlusCircle className="w-7 md:w-10 h-7 md:h-10 text-white/10 group-hover:text-[#D4AF37] transition-colors mb-2" />
              <p className="text-[7px] md:text-[10px] uppercase font-bold text-white/20 group-hover:text-[#D4AF37] text-center">Rejoindre</p>
            </div>
          </div>
        </section>
      );
        ...
        <section className="slide-enter flex flex-col md:flex-row items-center gap-10 max-w-6xl w-full text-left py-8">
          <div className="flex-1 space-y-6 text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
              <a href="tel:0616080174" className="flex items-center gap-4 glass p-4 rounded-2xl hover:border-[#0055A4] transition-all active:scale-95">
                ...
                <div><p className="text-[7px] md:text-[8px] text-slate-500 uppercase font-black tracking-widest">Hélène Mimenza</p><p className="font-black text-white text-[11px] md:text-sm tracking-tighter">06 16 08 01 74</p></div>
              </a>
              <a href="tel:0651332209" className="flex items-center gap-4 glass p-4 rounded-2xl hover:border-[#EF4135] transition-all active:scale-95">
                ...
                <div><p className="text-[7px] md:text-[8px] text-slate-500 uppercase font-black tracking-widest">Éric Sotoca</p><p className="font-black text-white text-[11px] md:text-sm tracking-tighter">06 51 33 22 09</p></div>
              </a>
            </div>
          </div>
          <div className="flex-1 w-full">
            <div className="glass p-6 md:p-8 rounded-[2rem] border-white/20 relative">
              <h3 className="text-lg md:text-xl font-black text-white mb-6 uppercase italic tracking-widest">Contact Mécénat</h3>
              <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); alert('Message envoyé ! Nous reviendrons vers vous très vite.'); }}>
                <input type="text" placeholder="Organisation / Entreprise" className="w-full bg-white/5 border border-white/10 rounded-xl p-4 focus:border-[#D4AF37] outline-none text-[11px] transition-all" />
                <input type="email" placeholder="Email professionnel" className="w-full bg-white/5 border border-white/10 rounded-xl p-4 focus:border-[#D4AF37] outline-none text-[11px] transition-all" />
                <textarea rows={3} placeholder="Votre projet..." className="w-full bg-white/5 border border-white/10 rounded-xl p-4 focus:border-[#D4AF37] outline-none text-[11px] transition-all resize-none"></textarea>
                <button className="w-full bg-gradient-to-r from-[#0055A4] via-white to-[#EF4135] py-4 rounded-xl text-black font-black uppercase text-sm md:text-base hover:scale-[1.02] active:scale-95 transition-all shadow-xl tracking-widest">
                  Valider
                </button>
              </form>
            </div>
  ...
  return (
    <div className="h-screen w-full flex flex-col bg-[#020617] text-slate-100 overflow-hidden nomad-pattern relative">
      ...
      <div className="fixed bottom-0 left-0 w-full z-40 p-4 md:p-8 flex justify-between items-center pointer-events-none mb-4">
        <button 
          onClick={prevSlide}
          className={`pointer-events-auto p-3 md:p-4 rounded-full glass hover:bg-white/10 transition-all ${currentSlide === 0 ? 'opacity-0 pointer-events-none' : 'opacity-100'} active:scale-90`}
        >
          <ChevronLeft className="w-5 md:w-6 h-5 md:h-6" />
        </button>
        <div className="glass px-4 md:px-6 py-2 rounded-full text-[10px] font-black tracking-[0.3em] text-white flex items-center gap-3 md:gap-4 pointer-events-auto shadow-2xl">
      ...
      <main className="flex-grow overflow-y-auto overflow-x-hidden scroll-smooth flex flex-col items-center">
        {/* Wrapper pour le centrage : justify-start sur mobile pour permettre de scroller du haut vers le bas */}
        <div className="w-full flex items-center justify-center min-h-full px-4 md:px-12 py-16 md:py-24">
           {/* margin: auto permet de centrer si le contenu est petit, tout en respectant le haut si c'est grand */}
           <div className="w-full flex flex-col items-center my-auto">
              {renderSlide(currentSlide)}
              {/* Spacer pour éviter que le contenu ne soit caché par la navigation mobile */}
              <div className="h-24 md:hidden w-full flex-shrink-0"></div>
           </div>
        </div>
      </main>
    </div>
