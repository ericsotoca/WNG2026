...
const App: React.FC = () => {
  ...
  const renderSlide = (index: number) => {
    switch(index) {
      case 0: return (
        <section className="slide-enter flex flex-col items-center text-center max-w-5xl py-12">
      ...
      case 1: return (
        <section className="slide-enter flex flex-col items-center text-center max-w-6xl w-full py-12">
      ...
      case 2: return (
        <section className="slide-enter flex flex-col md:flex-row items-center gap-12 max-w-6xl w-full text-left py-12">
          <div className="flex-1 space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold text-white uppercase italic tracking-tighter">Immersion Culturelle</h2>
          ...
          <div className="flex-1 w-full">
             <img src="https://eurasia.travel/wp-content/uploads/2024/09/World-Nomad-Games-in-Kyrgyzstan-19.jpg" className="rounded-[2rem] glass p-2 grayscale hover:grayscale-0 transition-all duration-700 w-full object-cover aspect-video md:aspect-auto" alt="Culture" />
          </div>
        </section>
      );
      case 3: return (
        <section className="slide-enter flex flex-col items-center max-w-6xl w-full py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full items-stretch">
            <div className="lg:col-span-8 flex flex-col justify-center text-left space-y-10">
              ...
              <div className="glass p-8 md:p-12 rounded-[2rem] md:rounded-[3rem] border-[#D4AF37]/20 relative overflow-hidden group">
                <div className="absolute top-0 right-0 p-8 opacity-5">
                  <Quote className="w-24 h-24 text-white" />
                </div>
                <p className="text-xl md:text-3xl text-white italic font-light leading-relaxed relative z-10">
              ...
              <div className="flex flex-wrap gap-4">
                 <div className="px-5 py-3 glass rounded-full flex items-center gap-3 border-[#0055A4]/30">
                    <Check className="text-[#0055A4] w-4 h-4" />
                    <span className="text-[10px] uppercase font-black text-slate-400 tracking-wider">Patrimoine UNESCO</span>
                 </div>
                 <div className="px-5 py-3 glass rounded-full flex items-center gap-3 border-[#EF4135]/30">
                    <Check className="text-[#EF4135] w-4 h-4" />
                    <span className="text-[10px] uppercase font-black text-slate-400 tracking-wider">Ambition Mondiale</span>
                 </div>
              </div>
            </div>
      ...
      case 4: return (
        <section className="slide-enter flex flex-col items-center max-w-6xl w-full text-center py-12">
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
            <div className="lg:col-span-8 relative group overflow-hidden rounded-[2.5rem] glass p-2 border-[#D4AF37]/20 border">
              <div className="w-full h-full min-h-[250px] overflow-hidden rounded-[2.2rem] relative bg-white/5">
                <img 
            ...
            <div className="lg:col-span-4 flex flex-col gap-4 text-left">
              <div className="glass p-6 rounded-[2rem] border-t-4 border-[#D4AF37] flex-grow">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#D4AF37] text-[10px] font-black uppercase tracking-wider">5<sup>ème</sup> Place Mondiale</p>
                  </div>
                </div>
              ...
              <div className="glass p-6 rounded-[2rem] border-t-4 border-[#0055A4] flex-grow">
                ...
                <div className="flex justify-between items-baseline mb-2">
                  <p className="text-[#0055A4] text-xs font-black uppercase tracking-wider">22<sup>ème</sup> Mondial</p>
      ...
      case 5: return (
        <section className="slide-enter flex flex-col items-center max-w-6xl w-full text-center py-12">
          <h2 className="text-3xl md:text-5xl font-black mb-12 text-white uppercase italic tracking-tighter">
          ...
          <div className="mt-12 flex justify-center">
            ...
            >
              ...
              <span className="text-[10px] uppercase font-black tracking-[0.3em] text-white/50 group-hover:text-white">Devenir Partenaire</span>
            </button>
          </div>
        </section>
      );
      case 6: return (
        <section className="slide-enter flex flex-col items-center max-w-6xl w-full py-12">
          <h2 className="text-3xl font-bold mb-12 text-white uppercase tracking-tighter">La Délégation 2026</h2>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 md:gap-8 w-full">
            {[
              ...
              <div key={i} className="flex flex-col items-center group">
                ...
                <p className="font-bold text-[11px] md:text-sm text-white text-center">{m.name}</p>
                <p className={`text-[8px] md:text-[10px] uppercase font-black tracking-widest mt-1 opacity-60 text-center`} style={{color: m.c}}>{m.role}</p>
              </div>
            ))}
          </div>
        </section>
      ...
      case 7: return (
        <section className="slide-enter flex flex-col items-center max-w-6xl w-full py-12">
          <h2 className="text-3xl font-bold mb-12 text-white uppercase italic tracking-tighter">Les Disciplines Maîtresses</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 w-full">
            {[
              { 
                name: "Awalé", 
                ...
                <div className="flip-card-inner">
                  <div className={`flip-card-front glass border-opacity-30 overflow-hidden flex flex-col`} style={{borderColor: d.c}}>
                    <div className="flex-grow flex items-center justify-center p-4">
                      <img src={d.img} className="max-w-full max-h-[160px] object-contain rounded-lg shadow-xl" alt={d.name} />
                    </div>
                    <h3 className="text-xl md:text-2xl font-bold text-white mb-6 uppercase italic">{d.name}</h3>
                  </div>
                  <div className="flip-card-back p-8 flex flex-col items-center justify-center text-center" style={{backgroundColor: d.c, color: d.c === "#D4AF37" ? "#000" : "#fff"}}>
      ...
      case 8: return (
        <section className="slide-enter flex flex-col items-center max-w-5xl w-full text-left py-12">
           <h2 className="text-3xl font-bold mb-12 text-white text-center uppercase italic tracking-tighter">Objectifs 2026</h2>
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full">
              {[
                ...
                <div key={i} className="flex gap-4 p-6 glass rounded-2xl border-l-4 transition-colors" style={{borderLeftColor: obj.color}}>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 font-light">{obj.desc}</p>
                  </div>
                </div>
              ))}
           </div>
      ...
      case 9: return (
        <section className="slide-enter flex flex-col items-center max-w-5xl w-full text-center py-12">
          <h2 className="text-3xl font-bold mb-12 text-white uppercase italic tracking-tighter">Calendrier Opérationnel</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 w-full">
             {[
               ...
               <div key={i} className="flex flex-col items-center">
                  <div className="w-10 h-10 rounded-full glass border border-white/20 flex items-center justify-center font-black text-[10px] text-[#D4AF37] mb-4">{s.date}</div>
                  <h4 className="font-bold text-white text-xs mb-1 uppercase tracking-widest">{s.label}</h4>
      ...
      case 10: return (
        <section className="slide-enter flex flex-col items-center max-w-5xl w-full py-12">
           <h2 className="text-3xl font-bold mb-10 text-white uppercase italic tracking-tighter">Budget & Investissement</h2>
           <div className="w-full glass p-8 md:p-10 rounded-[2rem] md:rounded-[3rem] grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 text-left items-center">
              <div>
                 <div className="mb-6">
                    <p className="text-[10px] uppercase text-slate-500 font-black tracking-[0.2em] mb-1">Besoin Global</p>
                    <p className="text-5xl md:text-6xl font-black text-white">5 640 <span className="text-2xl">€</span></p>
                 </div>
                 <div className="space-y-4">
                    <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest text-slate-400"><span>Transport Aérien</span><span>2 500 €</span></div>
                    <div className="h-1.5 bg-white/5 rounded-full overflow-hidden"><div className="h-full bg-[#0055A4] rounded-full w-[44%]"></div></div>
                    <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest text-slate-400"><span>Logistique & Vie</span><span>1 500 €</span></div>
                    <div className="h-1.5 bg-white/5 rounded-full overflow-hidden"><div className="h-full bg-[#EF4135] rounded-full w-[26%]"></div></div>
                 </div>
              </div>
              <div className="space-y-6">
                 <h4 className="text-lg md:text-xl font-bold text-[#D4AF37] italic uppercase">Opportunité RSE</h4>
                 <p className="text-slate-400 text-sm leading-relaxed font-light">Investir dans un projet à haute valeur culturelle, humaine et éducative avec une visibilité mondiale unique.</p>
                 <div className="inline-flex gap-4 items-center px-6 py-3 bg-white/5 rounded-full text-[9px] font-black uppercase text-white tracking-[0.2em]">
      ...
      case 11: return (
        <section className="slide-enter flex flex-col items-center max-w-6xl w-full text-center py-12">
          <h2 className="text-3xl font-bold mb-12 text-white uppercase italic tracking-tighter">Pourquoi nous rejoindre ?</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 w-full">
            {[
              { icon: Eye, title: "Visibilité", desc: "Audience de 50 millions de personnes." },
              { icon: Award, title: "Prestige", desc: "Excellence et histoire tricolore." },
              { icon: MapPinned, title: "Territoire", desc: "Ancrage PACA et Hautes-Alpes." },
              ...
              <div key={i} className="glass p-5 md:p-6 rounded-2xl group hover:bg-white/5 transition-all">
                 ...
                 <h4 className="text-sm md:text-lg font-bold text-white mb-2 uppercase italic">{item.title}</h4>
                 <p className="text-[8px] md:text-[10px] text-slate-500 leading-relaxed font-black uppercase tracking-widest">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
      ...
      case 12: return (
        <section className="slide-enter flex flex-col items-center max-w-6xl w-full py-12">
          <h2 className="text-3xl font-bold mb-12 text-white uppercase italic tracking-tighter">Offres de Partenariat</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 w-full text-left">
            <div className="glass p-6 md:p-8 rounded-3xl flex flex-col h-full border border-white/10">
               <h3 className="text-base font-black text-slate-400 uppercase mb-2 tracking-widest">Bronze</h3>
               <p className="text-3xl md:text-4xl font-black text-white mb-8">500 €</p>
               <ul className="text-[10px] space-y-3 text-slate-400 mb-10 flex-grow">
                 <li className="flex gap-2"><Check className="text-[#0055A4] w-3 h-3 mt-0.5" /> Logo sur site web</li>
                 <li className="flex gap-2"><Check className="text-[#0055A4] w-3 h-3 mt-0.5" /> Mentions réseaux sociaux</li>
                 <li className="flex gap-2"><Check className="text-[#0055A4] w-3 h-3 mt-0.5" /> Certificat de Mécénat</li>
               </ul>
               <button onClick={() => setCurrentSlide(14)} className="w-full py-3 rounded-xl border border-white/10 hover:bg-white/5 uppercase text-[9px] font-black tracking-widest">Choisir</button>
            </div>
            <div className="glass p-6 md:p-8 rounded-3xl flex flex-col h-full border-2 border-[#D4AF37] md:scale-105 bg-white/5 shadow-2xl">
               <div className="bg-[#D4AF37] text-black text-[9px] font-black px-4 py-1 rounded-full w-fit mb-4 uppercase">Le plus populaire</div>
               <h3 className="text-base font-black text-white uppercase mb-2 tracking-widest">Argent</h3>
               <p className="text-3xl md:text-4xl font-black text-white mb-8">1 500 €</p>
               <ul className="text-[10px] space-y-3 text-white/80 mb-10 flex-grow">
                 <li className="flex gap-2"><Check className="text-[#D4AF37] w-3 h-3 mt-0.5" /> Pack Bronze Inclus</li>
                 <li className="flex gap-2"><Check className="text-[#D4AF37] w-3 h-3 mt-0.5" /> Logo sur la Tenue Officielle</li>
                 <li className="flex gap-2"><Check className="text-[#D4AF37] w-3 h-3 mt-0.5" /> Branding lors des tournois</li>
               </ul>
               <button onClick={() => setCurrentSlide(14)} className="w-full py-3 rounded-xl bg-[#D4AF37] text-black uppercase text-[9px] font-black tracking-widest hover:scale-105 transition-transform">Participer</button>
            </div>
            <div className="glass p-6 md:p-8 rounded-3xl flex flex-col h-full border border-white/5">
               <h3 className="text-base font-black text-[#EF4135] uppercase mb-2 tracking-widest">Or / Platine</h3>
               <p className="text-3xl md:text-4xl font-black text-white mb-8">3 000 € +</p>
               <ul className="text-[10px] space-y-3 text-slate-400 mb-10 flex-grow">
                 <li className="flex gap-2"><Check className="text-[#EF4135] w-3 h-3 mt-0.5" /> Pack Argent Inclus</li>
                 <li className="flex gap-2"><Check className="text-[#EF4135] w-3 h-3 mt-0.5" /> Atelier Team Building</li>
                 <li className="flex gap-2"><Check className="text-[#EF4135] w-3 h-3 mt-0.5" /> Logo Principal</li>
               </ul>
               <button onClick={() => setCurrentSlide(14)} className="w-full py-3 rounded-xl border border-[#EF4135] text-[#EF4135] uppercase text-[9px] font-black tracking-widest hover:bg-[#EF4135]/10">Contact direct</button>
            </div>
          </div>
        </section>
      );
      case 13: return (
        <section className="slide-enter flex flex-col items-center max-w-6xl w-full text-center py-12">
          <h2 className="text-3xl font-bold mb-4 text-white uppercase italic tracking-tighter">Le Club des Partenaires</h2>
          <div className="tricolore-strip mx-auto mb-12"></div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 w-full">
            <div className="glass p-6 rounded-[2rem] flex flex-col items-center justify-center border-t-4 border-[#0055A4] h-40 md:h-48 transition-all">
              <div className="text-[8px] md:text-[10px] font-bold text-[#0055A4] uppercase mb-2 md:mb-4 tracking-widest">Soutien Local</div>
              <Landmark className="w-8 md:w-12 h-8 md:h-12 text-white/40 mb-2" />
              <p className="font-bold text-[10px] md:text-sm">Mairie de <br/>La Saulce</p>
            </div>
            <div className="glass p-6 rounded-[2rem] flex flex-col items-center justify-center border-t-4 border-[#EF4135] h-40 md:h-48 transition-all">
              <div className="text-[8px] md:text-[10px] font-bold text-[#EF4135] uppercase mb-2 md:mb-4 tracking-widest">Organisateur</div>
              <Shield className="w-8 md:w-12 h-8 md:h-12 text-white/40 mb-2" />
              <p className="font-bold text-[10px] md:text-sm">Comité WNG <br/>Officiel</p>
            </div>
            <div className="glass p-6 rounded-[2rem] flex flex-col items-center justify-center border-dashed border-2 border-white/10 h-40 md:h-48 group cursor-pointer hover:border-[#D4AF37]/30 transition-all" onClick={() => setCurrentSlide(14)}>
              <PlusCircle className="w-8 md:w-10 h-8 md:h-10 text-white/10 group-hover:text-[#D4AF37] transition-colors mb-2" />
              <p className="text-[8px] md:text-[10px] uppercase font-bold text-white/20 group-hover:text-[#D4AF37] text-center">Votre Logo <br/>Ici</p>
            </div>
            <div className="glass p-6 rounded-[2rem] flex flex-col items-center justify-center border-dashed border-2 border-white/10 h-40 md:h-48 group cursor-pointer hover:border-[#D4AF37]/30 transition-all" onClick={() => setCurrentSlide(14)}>
              <PlusCircle className="w-8 md:w-10 h-8 md:h-10 text-white/10 group-hover:text-[#D4AF37] transition-colors mb-2" />
              <p className="text-[8px] md:text-[10px] uppercase font-bold text-white/20 group-hover:text-[#D4AF37] text-center">Rejoindre</p>
            </div>
          </div>
        </section>
      );
          ...
          <div className="flex-1 space-y-8 text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <a href="tel:0616080174" className="flex items-center gap-4 glass p-4 rounded-2xl hover:border-[#0055A4] transition-all">
                <div className="w-8 md:w-10 h-8 md:h-10 bg-[#0055A4]/20 rounded-xl flex items-center justify-center"><Phone className="text-[#0055A4] w-4 md:w-5 h-4 md:h-5" /></div>
                <div><p className="text-[8px] text-slate-500 uppercase font-black tracking-widest">Hélène Mimenza</p><p className="font-black text-white text-xs md:text-sm tracking-tighter">06 16 08 01 74</p></div>
              </a>
              <a href="tel:0651332209" className="flex items-center gap-4 glass p-4 rounded-2xl hover:border-[#EF4135] transition-all">
                <div className="w-8 md:w-10 h-8 md:h-10 bg-[#EF4135]/20 rounded-xl flex items-center justify-center"><Phone className="text-[#EF4135] w-4 md:w-5 h-4 md:h-5" /></div>
                <div><p className="text-[8px] text-slate-500 uppercase font-black tracking-widest">Éric Sotoca</p><p className="font-black text-white text-xs md:text-sm tracking-tighter">06 51 33 22 09</p></div>
              </a>
            </div>
          </div>
          <div className="flex-1 w-full">
            <div className="glass p-6 md:p-8 rounded-[2rem] border-white/20 relative">
              ...
              <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); alert('Message envoyé ! Nous reviendrons vers vous très vite.'); }}>
                <input type="text" placeholder="Organisation / Entreprise" className="w-full bg-white/5 border border-white/10 rounded-xl p-4 focus:border-[#D4AF37] outline-none text-xs transition-all" />
                <input type="email" placeholder="Email professionnel" className="w-full bg-white/5 border border-white/10 rounded-xl p-4 focus:border-[#D4AF37] outline-none text-xs transition-all" />
                <textarea rows={3} placeholder="Votre projet..." className="w-full bg-white/5 border border-white/10 rounded-xl p-4 focus:border-[#D4AF37] outline-none text-xs transition-all"></textarea>
                <button className="w-full bg-gradient-to-r from-[#0055A4] via-white to-[#EF4135] py-4 rounded-xl text-black font-black uppercase text-base hover:scale-[1.02] active:scale-95 transition-all shadow-xl tracking-widest">
                  Valider
                </button>
              </form>
            </div>
  ...
  return (
    <div className="h-screen w-full flex flex-col bg-[#020617] text-slate-100 overflow-hidden nomad-pattern relative">
      ...
      <div className="fixed bottom-0 left-0 w-full z-40 p-4 md:p-8 flex justify-between items-center pointer-events-none mb-4">
        <button 
          onClick={prevSlide}
          className={`pointer-events-auto p-3 md:p-4 rounded-full glass hover:bg-white/10 transition-all ${currentSlide === 0 ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
        >
          <ChevronLeft className="w-5 md:w-6 h-5 md:h-6" />
        </button>
        <div className="glass px-4 md:px-6 py-2 rounded-full text-[10px] font-black tracking-[0.3em] text-white flex items-center gap-3 md:gap-4 pointer-events-auto">
          <span className="text-[#D4AF37]">{String(currentSlide + 1).padStart(2, '0')}</span>
          <div className="tricolore-strip rounded-full w-6 md:w-8"></div>
          <span className="opacity-40">{String(totalSlides).padStart(2, '0')}</span>
        </div>
        <button 
          onClick={nextSlide}
          className="pointer-events-auto p-3 md:p-4 rounded-full bg-gradient-to-r from-[#0055A4] to-[#EF4135] text-white transition-all shadow-xl shadow-blue-900/40 hover:scale-110 active:scale-90"
        >
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-4 md:p-12 relative overflow-y-auto md:overflow-hidden scroll-smooth">
        <div className="w-full flex items-center justify-center min-h-full">
           {renderSlide(currentSlide)}
        </div>
        <div className="h-24 md:hidden flex-shrink-0"></div> {/* Spacer for mobile nav */}
      </main>
    </div>
  );
};
